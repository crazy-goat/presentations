...
<div class="container">
    ...
    <div class="content-area">
        ...
        <div class="content">
            ...
            <div class="content2"><esi:include src="http://nginx/_component/content.php" /></div>
            <div class="content3"><esi:include src="http://nginx/_component/content.php" /></div>
            <div class="content4"><esi:include src="http://nginx/_component/content.php" /></div>
        </div>
    </div>
</div>
